      ...
      <div className="flex items-center justify-center py-8">
        <div className="flex w-full max-w-5xl flex-col gap-6 px-8 [&>ul>li>span]:text-cyan-400">
          ...
          <ul className="list-inside list-disc text-default-400">
            <li>
              <span className="font-extrabold">Overseer</span>: Refers to the Discord bot.
            </li>
            <li>
              <span className="font-extrabold">We</span>: Refers to the developers of Overseer.
            </li>
            <li>
              <span className="font-extrabold">Personal Information</span>: Refers to any data that can directly or
              indirectly identify a user.
            </li>
          </ul>
          <h2 className="font-extrabold text-3xl">Stored information</h2>
          <p className=" text-default-400">
            We store the following information for the proper functioning of our services:
          </p>
          <ul className="list-inside list-disc text-default-400">
            <li>
              <span className="font-extrabold">User IDs</span>: To link stored user configurations.
            </li>
            <li>
              <span className="font-extrabold">Server IDs</span>: To link stored server configurations.
            </li>
            <li>
              <span className="font-extrabold">Channel IDs</span>: To link stored channel configurations.
            </li>
            <li>
              <span className="font-extrabold">Channel IDs</span>: To link stored channel configurations.
            </li>
            <li>
              <span className="font-extrabold">Message IDs</span>: To link stored message configurations.
            </li>
            <li>
              <span className="font-extrabold">Roles IDs</span>: To link stored role configurations.
            </li>
          </ul>
          <h2 className="font-extrabold text-3xl">IP Addresses</h2>
          <p className=" text-default-400">
          ...
          <h2 className="font-extrabold text-3xl">Cookies</h2>
          <p className=" text-default-400">
          ...
          <h2 className="font-extrabold text-3xl">Data Retention and Protection Policy</h2>
          <p className=" text-default-400">
          ...
          <h2 className="font-extrabold text-3xl">Disclosure of Information</h2>
          <p className=" text-default-400">
            Overseer does not solicit, share or sell users' personal information to third parties, except for legal
            compliance.
          </p>
          <h2 className="font-extrabold text-3xl">User Rights</h2>
          <ul className="list-inside list-disc text-default-400">
            <li>
              <span className="font-extrabold">Access and Rectification</span>: The users can access and correct their
              personal information provided voluntarily through our support
            </li>
            <li>
              <span className="font-extrabold">Account Deletion</span>: Users can request the deletion of their account
              and associated information through our support.
            </li>
          </ul>
          <h2 className="font-extrabold text-3xl">Changes in the Privacy Policy</h2>
          <p className=" text-default-400">
